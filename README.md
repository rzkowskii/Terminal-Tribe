...
<a href="https://terminaltribe.com/">
  <img
    src="screenshots/operator-desk.jpg"
    alt="TerminalTribe live site operator desk with the Begin free Campaign 1 action"
    width="920"
  >
</a>
...
<table>
  <tr>
    <td width="33%">
      <img src="screenshots/first-objective.jpg" alt="TerminalTribe gameplay showing the first pwd objective and command mentor">
    </td>
    <td width="33%">
      <img src="screenshots/level-cleared.jpg" alt="TerminalTribe gameplay after clearing the pwd level">
    </td>
    <td width="33%">
      <img src="screenshots/field-notebook.jpg" alt="TerminalTribe field notebook command reference for pwd">
    </td>
  </tr>
  <tr>
